...
- **Architecture**: DeepSurv (Cox proportional hazards neural network)
- **Features**: 116 (43 biomarker expression + 50 Hallmark pathways + 20 immune/TME + 3 clinical)
- **Training data**: Public GEO cohorts (GSE42743 + GSE41613)
- **Risk threshold**: Derived from training out-of-fold median split
- **Mean C-index**: 0.681

See `models/survival_risk_model/model_metadata.json` and `validation_summary.json` for details.
